...
sudo docker run --name jwe_jmonitord_debian12.5_pwsh7.4.2${RUNENV} --restart=always --env PWSHSCRIPTFILE=JMonitor.ps1 -d -v ${WDIR}:/root/workdir  weseit/pwshddebian12
